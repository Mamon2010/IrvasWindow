...
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! no exports provided */function(e,o,s){"use strict";s.r(o);var n=s(/*! ./parts/modalView */"./js/parts/modalView.js"),t=s(/*! ./parts/form */"./js/parts/form.js"),r=s(/*! ./parts/tabs */"./js/parts/tabs.js");window.addEventListener("DOMContentLoaded",function(){Object(n.default)(),Object(t.default)(),Object(r.default)()})},"./js/parts/form.js":
/*!**************************!*\
  !*** ./js/parts/form.js ***!
  \**************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/es6.promise */"./node_modules/core-js/modules/es6.promise.js"),s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){var d="Спасибо за обращение, мы с вами скоро свяжемся",c="Что то пошло не так",l=document.createElement("div");l.classList.add("status");var e=document.querySelectorAll("[name = user_phone]");document.querySelectorAll(".form").forEach(function(e){var r,u;u=(r=e).getElementsByTagName("input"),r.addEventListener("submit",function(e){e.preventDefault(),r.appendChild(l);var o=new FormData(r),s={};o.forEach(function(e,o){s[o]=e});var n,t=JSON.stringify(s);(n=t,new Promise(function(e,o){var s=new XMLHttpRequest;s.open("POST","server.php"),s.setRequestHeader("Content-Type","application/json; charset=utf-8"),s.addEventListener("readystatechange",function(){4===s.readyState&&(200==s.status?e():o())}),s.send(n)})).then(function(){return l.innerHTML=d}).catch(function(){return l.innerHTML=c}).then(function(){for(var e=0;e<u.length;e++)u[e].value=""}).then(setTimeout(function(){document.querySelector("form .status").remove()},3e3))})}),e.forEach(function(e){e.addEventListener("input",function(){/^(8|\+7|\+)\d{0,10}$/.test(e.value)?e.value=e.value:e.value=e.value.slice(0,-1)})})}},"./js/parts/modalView.js":
/*!*******************************!*\
  !*** ./js/parts/modalView.js ***!
  \*******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){function o(e){e.style.display="block",document.body.style.overflow="hidden"}function e(o){t.forEach(function(e){e.addEventListener("click",function(){o.style.display="none",document.body.style.overflow=""})}),o.addEventListener("click",function(e){e.target==o&&(o.style.display="none",document.body.style.overflow="")})}var s=document.querySelector(".header_btn"),n=document.querySelector(".popup_engineer"),t=document.querySelectorAll(".popup_close");s.addEventListener("click",function(e){e.preventDefault(),o(n)}),e(n);var r=document.querySelector(".phone_link"),u=document.querySelector(".popup");r.addEventListener("click",function(e){e.preventDefault(),o(u)}),document.querySelector(".phone_link_question").addEventListener("click",function(e){e.preventDefault(),o(u)}),e(u),setTimeout(function(){o(u)},6e4)}},"./js/parts/tabs.js":
/*!**************************!*\
  !*** ./js/parts/tabs.js ***!
  \**************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o),o.default=function(){function n(e,o,s){for(var n=3<arguments.length&&void 0!==arguments[3]?arguments[3]:"",t=e;t<s.length;t++)s[t].classList.remove("show"),s[t].classList.add("hide"),o[t].classList.remove(n)}function t(e,o,s){var n=3<arguments.length&&void 0!==arguments[3]?arguments[3]:"";s[e].classList.contains("hide")&&(s[e].classList.remove("hide"),s[e].classList.add("show"),o[e].classList.add(n))}var e=document.querySelector(".glazing_slider"),r=document.querySelectorAll(".glazing_block"),u=document.querySelectorAll(".glazing_block_a"),d=document.querySelectorAll(".glazing_content");n(1,r,d,"active"),e.addEventListener("click",function(e){var o=e.target;if(o&&o.classList.contains("glazing_block_a"))for(var s=0;s<u.length;s++)if(o==u[s]){n(0,r,d,"active"),t(s,r,d,"active");break}});var c=document.querySelectorAll(".decoration_tabcontent"),l=document.querySelectorAll(".decoration_link"),i=document.querySelectorAll(".decoration_link_a"),o=document.querySelector(".decoration_slider");n(1,l,c,"after_click"),o.addEventListener("click",function(e){var o=e.target;if(o&&o.classList.contains("decoration_link_a"))for(var s=0;s<i.length;s++)if(o==i[s]){n(0,l,c,"after_click"),t(s,l,c,"after_click");break}})}},"./node_modules/core-js/modules/_a-function.js":
/*!*****************************************************!*\
...
/*!*************************************************!*\
  ...
  \*************************************************/
/*! no static exports found */function(e,o,s){var f=s(/*! ./_global */"./node_modules/core-js/modules/_global.js"),p=s(/*! ./_core */"./node_modules/core-js/modules/_core.js"),v=s(/*! ./_hide */"./node_modules/core-js/modules/_hide.js"),h=s(/*! ./_redefine */"./node_modules/core-js/modules/_redefine.js"),y=s(/*! ./_ctx */"./node_modules/core-js/modules/_ctx.js"),b="prototype",g=function(e,o,s){var n,t,r,u,d=e&g.F,c=e&g.G,l=e&g.S,i=e&g.P,m=e&g.B,a=c?f:l?f[o]||(f[o]={}):(f[o]||{})[b],j=c?p:p[o]||(p[o]={}),_=j[b]||(j[b]={});for(n in c&&(s=o),s)r=((t=!d&&a&&void 0!==a[n])?a:s)[n],u=m&&t?y(r,f):i&&"function"==typeof r?y(Function.call,r):r,a&&h(a,n,r,e&g.U),j[n]!=r&&v(j,n,u),i&&_[n]!=r&&(_[n]=r)};f.core=p,g.F=1,g.G=2,g.S=4,g.P=8,g.B=16,g.W=32,g.U=64,g.R=128,e.exports=g},"./node_modules/core-js/modules/_fails.js":
/*!************************************************!*\
...
/*!****************************************************!*\
  ...
  \****************************************************/
/*! no static exports found */function(e,o,s){var d=s(/*! ./_global */"./node_modules/core-js/modules/_global.js"),c=s(/*! ./_task */"./node_modules/core-js/modules/_task.js").set,l=d.MutationObserver||d.WebKitMutationObserver,i=d.process,m=d.Promise,a="process"==s(/*! ./_cof */"./node_modules/core-js/modules/_cof.js")(i);e.exports=function(){var s,n,t,e=function(){var e,o;for(a&&(e=i.domain)&&e.exit();s;){o=s.fn,s=s.next;try{o()}catch(e){throw s?t():n=void 0,e}}n=void 0,e&&e.enter()};if(a)t=function(){i.nextTick(e)};else if(!l||d.navigator&&d.navigator.standalone)if(m&&m.resolve){var o=m.resolve(void 0);t=function(){o.then(e)}}else t=function(){c.call(d,e)};else{var r=!0,u=document.createTextNode("");new l(e).observe(u,{characterData:!0}),t=function(){u.data=r=!r}}return function(e){var o={fn:e,next:void 0};n&&(n.next=o),s||(s=o,t()),n=o}}},"./node_modules/core-js/modules/_new-promise-capability.js":
/*!*****************************************************************!*\
