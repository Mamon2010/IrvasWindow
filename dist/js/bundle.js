...
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! no exports provided */function(e,o,s){"use strict";s.r(o);var t=s(/*! ./parts/form */"./js/parts/form.js"),n=s(/*! ./parts/modalView */"./js/parts/modalView.js"),r=s(/*! ./parts/tabs */"./js/parts/tabs.js"),u=s(/*! ./parts/image */"./js/parts/image.js"),d=s(/*! ./parts/timer */"./js/parts/timer.js");window.addEventListener("DOMContentLoaded",function(){Object(n.default)(),Object(t.default)(),Object(r.default)(),Object(u.default)(),Object(d.default)()})},"./js/parts/form.js":
/*!**************************!*\
  !*** ./js/parts/form.js ***!
  \**************************/
...
/*!**************************!*\
  !*** ./js/parts/tabs.js ***!
  \**************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o),o.default=function(){function t(e,o,s){for(var t=3<arguments.length&&void 0!==arguments[3]?arguments[3]:"",n=e;n<s.length;n++)s[n].classList.remove("show"),s[n].classList.add("hide"),o[n].classList.remove(t)}function n(e,o,s){var t=3<arguments.length&&void 0!==arguments[3]?arguments[3]:"";s[e].classList.contains("hide")&&(s[e].classList.remove("hide"),s[e].classList.add("show"),o[e].classList.add(t))}var e=document.querySelector(".glazing_slider"),r=document.querySelectorAll(".glazing_block"),u=document.querySelectorAll(".glazing_block_a"),d=document.querySelectorAll(".glazing_content");t(0,r,d,"active"),n(0,r,d,"active"),e.addEventListener("click",function(e){var o=e.target;if(o&&o.closest("div").classList.contains("glazing_block"))for(var s=0;s<u.length;s++)if(o.closest("div")==r[s]){t(0,r,d,"active"),n(s,r,d,"active");break}});var c=document.querySelectorAll(".decoration_tabcontent"),l=document.querySelectorAll(".decoration_link"),i=document.querySelectorAll(".decoration_link_a"),o=document.querySelector(".decoration_slider"),a=document.querySelectorAll(".decoration_item");t(1,l,c,"after_click"),o.addEventListener("click",function(e){var o=e.target;if(o&&o.closest(".decoration_item").classList.contains("decoration_item"))for(var s=0;s<i.length;s++)if(o.closest(".decoration_item")==a[s]){t(0,l,c,"after_click"),n(s,l,c,"after_click");break}})}},"./js/parts/timer.js":
/*!***************************!*\
  !*** ./js/parts/timer.js ***!
  \***************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o),o.default=function(){var e,o,s,t,n,r,u,d;function c(e){var o=e;return e<0?o="00":e<10&&(o="0"+e),o}e="timer",o="12.31.2018",s=document.getElementById(e),t=s.querySelector("#days"),n=s.querySelector("#hours"),r=s.querySelector("#minutes"),u=s.querySelector("#seconds"),d=setInterval(function(){var e=function(e){(new Date).getTimezoneOffset();var o=Date.parse(e)-Date.parse(new Date),s=Math.floor(o/1e3%60),t=Math.floor(o/1e3/60%60),n=Math.floor(o/36e5%60);return{days:Math.floor(o/864e5),hours:n,minutes:t,seconds:s}}(o);t.textContent=c(e.days),n.textContent=c(e.hours),r.textContent=c(e.minutes),u.textContent=c(e.seconds),e.total<=0&&clearInterval(d)},1e3)}},"./node_modules/core-js/modules/_a-function.js":
/*!*****************************************************!*\
